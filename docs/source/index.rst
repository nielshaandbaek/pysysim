.. PySySim documentation master file, created by
   sphinx-quickstart on Mon Jan 25 13:21:17 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to pySySim's documentation!
===================================
...
The simulation is executed for 100 ns and generates a VCD file with all registered signals.
...
Installation
~~~~~~~~~~~~
Install locally using pip_::

  $ pip install -e pysysim
